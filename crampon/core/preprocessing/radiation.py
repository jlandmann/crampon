...
if __name__ == '__main__':
    ...
    # done: Gries, Rhone, Silvretta, Findelen
    bdir = 'c:\\users\\johannes\\documents\\modelruns\\CH\\per_glacier'
    #gdirs = [utils.GlacierDirectory(id, base_dir=bdir) for id in
    #         ['RGI50-11.B4312n-1', 'RGI50-11.A55F03', 'RGI50-11.B4504',
    #          'RGI50-11.B5616n-1', 'RGI50-11.A10G05', 'RGI50-11.C1410']]
    gdirs = [utils.GlacierDirectory(gid, base_dir=bdir) for gid in
             ['RGI50-11.A10G05']]
    ...
    for gdir in gdirs:
        get_potential_irradiation_with_toposhade(gdir)
